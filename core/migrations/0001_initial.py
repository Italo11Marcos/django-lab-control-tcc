    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('SL', 'Software Livre'), ('SP', 'Software Licenciado')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('MN', 'Manutenção'), ('AT', 'Atualização'), ('IT', 'Instalação'), ('CR', 'Criação'), ('RV', 'Reserva'), ('EM', 'Empréstimo')], max_length=2)),
